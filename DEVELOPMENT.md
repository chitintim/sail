...
### GPS Permission Flow
1. Show "Enable GPS" / "Continue Without" buttons immediately
2. Only request permission when user taps Enable
3. Fallback to San Francisco Bay if no GPS
...
## Phase 3: Weather Integration (PLANNED)
...
### iOS Safari GPS
- Requires HTTPS
- Must request on user interaction
- Settings > Safari > Location must be enabled

### Service Worker Caching
- Hard refresh may be needed for updates
